...
class _FormPartElevenPageState extends State<FormPartElevenPage> {
                    ...
                    SaveProblemButtonWidget(
                      onPressed: file != null
                          ? () {
                              saveDataToDatabase();
                              setState(() {
                                widget.problemsPartEleven.add(
                                    "${widget.currentRoom} Poikkeama: ${problemElevenController.text}");
                                widget.accountablePeoplePartEleven
                                    .add(problemsAccountablePeople);
                                widget.urgenciesPartEleven.add(currentUrgency);
                                widget.problemCardsPartEleven.add(
                                  Card(
                                    child: Column(
                                      children: [
                                        Text(
  ...
  Future saveDataToDatabase() async {
    ...
    _problemData.problem =
        "${widget.currentRoom} ${problemElevenController.text.trim()}";
    ...
    setState(() {
      problem11Id++;
      widget.imgUrlsProblemsPartEleven.add(urlDownload);
    });
  }
