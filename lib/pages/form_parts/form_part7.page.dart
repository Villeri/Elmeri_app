...
class _FormPartSevenPageState extends State<FormPartSevenPage> {
                    ...
                    SaveProblemButtonWidget(
                      onPressed: file != null
                          ? () {
                              saveDataToDatabase();
                              setState(() {
                                widget.problemsPartSeven.add(
                                    "${widget.currentRoom} Poikkeama: ${problemSevenController.text}");
                                widget.accountablePeoplePartSeven
                                    .add(problemsAccountablePeople);
                                widget.urgenciesPartSeven.add(currentUrgency);
                                widget.problemCardsPartSeven.add(
                                  Card(
                                    child: Column(
                                      children: [
                                        Text(
  ...
  Future saveDataToDatabase() async {
    ...
    _problemData.problem =
        "${widget.currentRoom} ${problemSevenController.text.trim()}";
    ...
    setState(() {
      problem7Id++;
      widget.imgUrlsProblemsPartSeven.add(urlDownload);
    });
  }
