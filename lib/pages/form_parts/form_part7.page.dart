...
import 'form_part8_page.dart';

class FormPartSevenPage extends StatefulWidget {
  String currentRoom;
  ...
  @override
  State<FormPartSevenPage> createState() => _FormPartSevenPageState();
}

class _FormPartSevenPageState extends State<FormPartSevenPage> {
  int thingsOk7 = 0;
  int thingsNotOk7 = 0;
  TextEditingController problemSevenController = TextEditingController();
      ...
      body: SingleChildScrollView(
        child: Center(
          child: Column(
            children: [
              FormCardWidget(
                headerText: "7. Poistumistiet",
                thingsOk: thingsOk7.toString(),
                thingsNotOk: thingsNotOk7.toString(),
                plusThingsOk: plusThingsOkPartSeven,
                minusThingsOk: minusThingsOkPartSeven,
                plusThingsNotOk: plusThingsNotOkPartSeven,
                minusThingsNotOk: minusThingsNotOkPartSeven,
              ),
                ...
                child: Column(
                  children: [
                    ...
                    ProblemCardProblemsWidget(
                      controller: problemSevenController,
                    ),
                    const SizedBox(height: 15),
                    const Text(
                      "Vastuutahot:",
                    ...
                    SaveProblemButtonWidget(
                      onPressed: file != null
                          ? () {
                              ...
                              setState(() {
                                problemsPartSeven
                                    .add(problemSevenController.text);
                                accountablePeoplePartSeven
                                    .add(accountablePeoplePartSeven);
                                urgenciesPartSeven.add(currentUrgency);
                                problemCardsPartSeven.add(
                                  Card(
                                    child: Column(
                                      children: [
                                        Text(
                                            "Poikkeama: ${problemSevenController.text}",
                                            style:
              ...
              NextButton(onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => FormPartEightPage(
                              ...
                              accountablePeoplePartSeven:
                                  accountablePeoplePartSeven,
                              imgUrlsPartSeven: imgUrlsProblemsPartSeven,
                              problemCardsPartSeven: problemCardsPartSeven,
  ...
  plusThingsOkPartSeven() {
    setState(() {
      thingsOk7++;
    });
  }

  minusThingsOkPartSeven() {
    if (thingsOk7 > 0) {
      setState(() {
        thingsOk7--;
      });
  ...
  plusThingsNotOkPartSeven() {
    setState(() {
      thingsNotOk7++;
    });
  }

  minusThingsNotOkPartSeven() {
    if (thingsNotOk7 > 0) {
      setState(() {
        thingsNotOk7--;
      });
  ...
  Future saveDataToDatabase() async {
    if (file == null) return;
    final fileName = "part7problem$problem7Id";
    final destination = "files/$fileName";
    _problemData.problem = problemSevenController.text.trim();
    _problemData.accountablePeople = problemsAccountablePeople;
    _problemData.urgency = currentUrgency;
    _problemData.problemId = problem7Id.toString();
    ...
    setState(() {
      problem7Id++;
      imgUrlsProblemsPartSeven.add(urlDownload);
    });
  }
