...
class _FormPartThirteenPageState extends State<FormPartThirteenPage> {
                    ...
                    SaveProblemButtonWidget(
                      onPressed: file != null
                          ? () {
                              saveDataToDatabase();
                              setState(() {
                                widget.problemsPartThirteen.add(
                                    "${widget.currentRoom} Poikkeama: ${problemThirteenController.text}");
                                widget.accountablePeoplePartThirteen
                                    .add(problemsAccountablePeople);
                                widget.urgenciesPartThirteen
                                    .add(currentUrgency);
                                widget.problemCardsPartThirteen.add(
                                  Card(
                                    child: Column(
                                      children: [
                                        Text(
                                ...
                                problemThirteenController.text = "";
                              });
                            }
                          : () {
  ...
  Future saveDataToDatabase() async {
    ...
    _problemData.problem =
        "${widget.currentRoom} ${problemThirteenController.text.trim()}";
    ...
    setState(() {
      problem13Id++;
      widget.imgUrlsProblemsPartThirteen.add(urlDownload);
    });
  }
