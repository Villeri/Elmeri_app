...
class _FormPartEightPageState extends State<FormPartEightPage> {
                    ...
                    SaveProblemButtonWidget(
                      onPressed: file != null
                          ? () {
                              saveDataToDatabase();
                              setState(() {
                                widget.problemsPartEight.add(
                                    "${widget.currentRoom} Poikkeama: ${problemEightController.text}");
                                widget.accountablePeoplePartEight
                                    .add(problemsAccountablePeople);
                                widget.urgenciesPartEight.add(currentUrgency);
                                widget.problemCardsPartEight.add(
                                  Card(
                                    child: Column(
                                      children: [
                                        Text(
  ...
  Future saveDataToDatabase() async {
    ...
    _problemData.problem =
        "${widget.currentRoom} ${problemEightController.text.trim()}";
    ...
    setState(() {
      problem8Id++;
      widget.imgUrlsProblemsPartEight.add(urlDownload);
    });
  }
