...
class _FormPartFourPageState extends State<FormPartFourPage> {
                    ...
                    SaveProblemButtonWidget(
                      onPressed: file != null
                          ? () {
                              saveDataToDatabase();
                              setState(() {
                                widget.problemsPartFour.add(
                                    "${widget.currentRoom} ${problemFourController.text}");
                                widget.accountablePeoplePartFour
                                    .add(problemsAccountablePeople);
                                widget.urgenciesPartFour.add(currentUrgency);
                                widget.problemCardsPartFour.add(
                                  Card(
                                    child: Column(
                                      children: [
                                        Text(
                                            "${widget.currentRoom} Poikkeama: ${problemFourController.text}",
                                            style:
  ...
  Future saveDataToDatabase() async {
    ...
    _problemData.problem =
        "${widget.currentRoom} ${problemFourController.text.trim()}";
    ...
    setState(() {
      problem4Id++;
      widget.imgUrlsProblemsPartFour.add(urlDownload);
    });
  }
