...
class _FormPartSixPageState extends State<FormPartSixPage> {
                    ...
                    SaveProblemButtonWidget(
                      onPressed: file != null
                          ? () {
                              saveDataToDatabase();
                              setState(() {
                                widget.problemsPartSix.add(
                                    "${widget.currentRoom} ${problemSixController.text}");
                                widget.accountablePeoplePartSix
                                    .add(problemsAccountablePeople);
                                widget.urgenciesPartSix.add(currentUrgency);
                                widget.problemCardsPartSix.add(
                                  Card(
                                    child: Column(
                                      children: [
                                        Text(
                                            "${widget.currentRoom} Poikkeama: ${problemSixController.text}",
                                            style:
  ...
  Future saveDataToDatabase() async {
    ...
    _problemData.problem =
        "${widget.currentRoom} ${problemSixController.text.trim()}";
    ...
    setState(() {
      problem6Id++;
      widget.imgUrlsProblemsPartSix.add(urlDownload);
    });
  }
