...
class _FormPartNinePageState extends State<FormPartNinePage> {
                    ...
                    SaveProblemButtonWidget(
                      onPressed: file != null
                          ? () {
                              saveDataToDatabase();
                              setState(() {
                                widget.problemsPartNine.add(
                                    "${widget.currentRoom} Poikkeama: ${problemNineController.text}");
                                widget.accountablePeoplePartNine
                                    .add(problemsAccountablePeople);
                                widget.urgenciesPartNine.add(currentUrgency);
                                widget.problemCardsPartNine.add(
                                  Card(
                                    child: Column(
                                      children: [
                                        Text(
  ...
  Future saveDataToDatabase() async {
    ...
    _problemData.problem =
        "${widget.currentRoom} ${problemNineController.text.trim()}";
    ...
    setState(() {
      problem9Id++;
      widget.imgUrlsProblemsPartNine.add(urlDownload);
    });
  }
