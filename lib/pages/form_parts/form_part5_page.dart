...
class _FormPartFivePageState extends State<FormPartFivePage> {
                    ...
                    SaveProblemButtonWidget(
                      onPressed: file != null
                          ? () {
                              saveDataToDatabase();
                              setState(() {
                                widget.problemsPartFive.add(
                                    "${widget.currentRoom} ${problemFiveController.text}");
                                widget.accountablePeoplePartFive
                                    .add(problemsAccountablePeople);
                                widget.urgenciesPartFive.add(currentUrgency);
                                widget.problemCardsPartFive.add(
                                  Card(
                                    child: Column(
                                      children: [
                                        Text(
                                            "${widget.currentRoom} Poikkeama: ${problemFiveController.text}",
                                            style:
  ...
  Future saveDataToDatabase() async {
    ...
    _problemData.problem =
        "${widget.currentRoom} ${problemFiveController.text.trim()}";
    ...
    setState(() {
      problem5Id++;
      widget.imgUrlsProblemsPartFive.add(urlDownload);
    });
  }
