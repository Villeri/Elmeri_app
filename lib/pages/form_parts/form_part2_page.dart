...
class _FormPartTwoPageState extends State<FormPartTwoPage> {
                    ...
                    SaveProblemButtonWidget(
                      onPressed: file != null
                          ? () {
                              saveDataToDatabase();
                              setState(() {
                                widget.problemsPartTwo.add(
                                    "${widget.currentRoom} ${problemTwoController.text}");
                                widget.accountablePeoplePartTwo
                                    .add(problemsAccountablePeople);
                                widget.urgenciesPartTwo.add(currentUrgency);
                                widget.problemCardsPartTwo.add(
                                  Card(
                                    child: Column(
                                      children: [
                                        Text(
                                            "${widget.currentRoom} Poikkeama: ${problemTwoController.text}",
                                            style:
  ...
  Future saveDataToDatabase() async {
    ...
    _problemData.problem =
        "${widget.currentRoom} ${problemTwoController.text.trim()}";
    ...
    setState(() {
      problem2Id++;
      widget.imgUrlsProblemsPartTwo.add(urlDownload);
    });
  }
