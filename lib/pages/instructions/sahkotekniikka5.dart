...
class Sahkotekniikka5 extends StatefulWidget {
  const Sahkotekniikka5({Key? key}) : super(key: key);

  @override
  _Sahkotekniikka5State createState() => _Sahkotekniikka5State();
}

class _Sahkotekniikka5State extends State<Sahkotekniikka5> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text("Sähkötekniikka 5A105")),
        body: SafeArea(
          child: Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Image.asset("assets/images/5A105.jpg"),
                  ...
                  Padding(
                    ...
                    child: Text("Tila lukittu, kun ei ole käytössä.",
                  ...
                  const Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Text(
                      "Havainnoitavat laitteet (vain siirrettäviä opetuslaitteita ja kiinteät pisteet):",
