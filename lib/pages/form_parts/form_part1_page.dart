...
class _FormPartOnePageState extends State<FormPartOnePage> {
                    ...
                    SaveProblemButtonWidget(
                      onPressed: file != null
                          ? () {
                              saveDataToDatabase();
                              setState(() {
                                widget.problemsPartOne.add(
                                    "${widget.currentRoom} ${problemOneController.text}");
                                widget.accountablePeoplePartOne
                                    .add(problemsAccountablePeople);
                                widget.urgenciesPartOne.add(currentUrgency);
                                widget.problemCardsPartOne.add(
                                  Card(
                                    child: Column(
                                      children: [
                                        Text(
                                            "${widget.currentRoom} Poikkeama: ${problemOneController.text}",
                                            style:
  ...
  Future saveDataToDatabase() async {
    ...
    _problemData.problem =
        "${widget.currentRoom} ${problemOneController.text.trim()}";
    ...
    setState(() {
      problem1Id++;
      widget.imgUrlsProblemsPartOne.add(urlDownload);
    });
  }
